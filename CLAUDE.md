...
5. **No new `webkitdirectory` / `webkitGetAsEntry` usage.** They behave inconsistently across desktop webviews. The existing two uses in `index.html` and `app.js` stay; don't add more.
